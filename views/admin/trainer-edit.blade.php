                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title bariol-thin">
                            {!! !empty($item->id) ? '<i class="fa fa-pencil"></i>' . trans($plang_admin . '.pages.title-edit') : '<i class="fa fa-users"></i>' . trans($plang_admin . '.pages.title-add') !!}
                        </h3>
                    </div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12 col-xs-12">
                                ...
                                @include('package-trainer::admin.trainer-form')
